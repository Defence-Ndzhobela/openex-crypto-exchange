...
export default function TradePage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="bg-[#111] border-b border-[#222] px-4 h-12 flex items-center gap-8 overflow-x-auto scrollbar-hide shrink-0">
        ...
        <div className="ml-auto flex items-center gap-4 shrink-0">
          <div className="flex items-center gap-1 text-[10px] text-green-500 bg-green-500/10 px-2 py-0.5 rounded border border-green-500/20">
            <Activity className="w-3 h-3" />
            <span className="font-bold uppercase">Real-time</span>
          </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 border-r border-[#222]">
          ...
          <div className="h-[250px] border-t border-[#222] bg-[#111]">
            <div className="flex border-b border-[#222]">
              <button className="px-6 py-3 text-xs font-bold text-yellow-500 border-b-2 border-yellow-500 shrink-0">
                Open Orders
              </button>
              <button className="px-6 py-3 text-xs font-bold text-gray-400 hover:text-white shrink-0">
                Order History
              </button>
              <button className="px-6 py-3 text-xs font-bold text-gray-400 hover:text-white shrink-0">
                Trade History
        ...
        {/* Middle: Order Book */}
        <div className="w-full lg:w-[320px] shrink-0 border-r border-[#222] bg-[#0a0a0a] flex flex-col">
          <OrderBook />
        </div>

        {/* Right: Trade Form and Feeds */}
        <div className="w-full lg:w-[320px] shrink-0 bg-[#0a0a0a] flex flex-col">
